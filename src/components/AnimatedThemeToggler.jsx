...
export default function AnimatedThemeToggler({
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className={cn(
        "text-light-text hover:text-primary transition-colors duration-200 cursor-pointer bg-transparent border-none p-1.5 flex items-center justify-center rounded-lg hover:bg-primary/10",
        className
      )}
