                ...
                >
                  {({ isActive }) => (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group/proj block w-full h-full bg-input-bg border border-primary/10 rounded-2xl p-3.5 sm:p-5 transition-all duration-300 no-underline shadow-md project-card-3d"
                    >
